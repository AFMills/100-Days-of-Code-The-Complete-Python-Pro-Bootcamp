...
class FlightSearch:
    ...
    def check_flights(self, origin_city_code, destination_city_code, departure_time, arrival_time):
        headers = {
            "Authorization" : f"Bearer {self._token}"
        }
        parameters = {
            ...
            "departureDate" : departure_time.strftime("%Y-%m-%d"),
            "returnDate" : arrival_time.strftime("%Y-%m-%d"),
            "adults" : 1,
            "nonStop" : "true",
            "currencyCode" : "GBP",
            "max" : "10",
